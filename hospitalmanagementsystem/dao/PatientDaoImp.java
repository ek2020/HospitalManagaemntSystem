...
public class PatientDaoImp implements PatientDaoInterface {
	...
	public boolean insert(Patient patient) {
		...
		String query = "INSERT into t_user(user_street,user_phone_number,fk_role_id,user_city,use_state,user_country,name,user_name,password) VALUES (?,?,?,?,?,?,?,?,?)";
		Connection con = null;
		try {
			...
			statement.setString(8, patient.getUserName());
